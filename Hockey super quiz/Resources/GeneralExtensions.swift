...
extension UITableView {
    ...
    func setEmptyMessage(_ message: String) {
        ...
        messageLabel.textColor = UIColor(red: 111/255.0, green: 125/255.0, blue: 151/255.0, alpha: 1)
        messageLabel.numberOfLines = 0
        messageLabel.textAlignment = .center
//        messageLabel.font = UIFont.systemFont(ofSize: 15.0)
//        messageLabel.font = UIFont(name:"SourceSansPro-Regular", size: 16.0)
        messageLabel.font = UIFont .init(name: "Rubik-Regular", size: 20)
